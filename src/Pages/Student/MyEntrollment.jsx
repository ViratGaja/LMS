...
const MyEntrollment = () => {
  ...
  return (
    <div className="md:px-36 px-8 pt-10">
      ...
      {/* Desktop Table */}
      <div className="block sm:block mt-10">
          ...
          <tbody className="text-gray-700">
            {entrolledCourses.map((course, index) => (
              <tr className="border-b border-gray-500/20" key={index}>
                ...
                <td className="px-4 py-3">{progressArray[index]&& `${progressArray[index].lectureCompleted}/${progressArray[index].totalLectures}`}<span>Lectures</span></td>
